...
import com.example.myapplication.GameBoardRenderer
...
class MainActivity : ComponentActivity() {
    ...
    fun GameBoardContent() {
        ...
        gameBoardRenderer.getSpielfeldFromGameBoard()
    }
}
...
fun StartScreen(onStartButtonClick: () -> Unit) {
    ...
    Column(
        ...
        Row(
            ...
            Text(text = "$currentNumberOfPlayers", style = MaterialTheme.typography.titleSmall)
